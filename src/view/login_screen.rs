use crate::view::appstate_to_login_state_lens::LoginLens;
use crate::view::view_types::{AppState, LoginData, LOG_IN};
...
impl LoginScreen {
    pub fn new(widget: Box<dyn Widget<AppState>>) -> Self {
        Self { widget }
    }
}
